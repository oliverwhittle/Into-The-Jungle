  ...
  return (
    <StyledWrapper>
      <div className="comic-brutal-button-container">
        <button className="comic-brutal-button" onClick={() => window.location.href='https://www.eventbrite.com/e/into-the-jungle-tickets-1981935017991?aff=oddtdtcreator'}>
...
const StyledWrapper = styled.div`
  .comic-brutal-button-container {
    --primary-color: #2e5a42;
    --secondary-color: #2bc03f;
    --text-color: #ffffff;
    --accent-color: #f5be0c;
    --panel-color: #002511;
